...
//         s+=fun(n-group[ind],minProfit-profit[ind],group,profit,ind+1,dp);
//         s+=fun(n,minProfit,group,profit,ind+1,dp);
        
//         return dp[minProfit][n][ind]=s%mod;
//     }
// public:
...
//         //      sum[i]=somu;
//         // }
//         vector<vector<vector<int>>> dp(10000,vector<vector<int>>(n+1,vector<int>(s,-1)));
